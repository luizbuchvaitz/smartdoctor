<?php
    ...
    $aPron = ConsultarDados("prontuario", "cdpron", $chave);
    ...
    if (count($aPara) > 0 ){
        ...
        echo 'Dados dos parâmetros não foram cadastrados. Contacte o suporte técnico!';
        die();
    }
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-edit"></i> Cadastro de Prontuário - <small><?php echo $titulo; ?></small>
                            </button>
                        </div>

                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="prontuarioaa.php">
                                <div>
                                    <center>
                                        <?php if($acao == "edita") {?>
                                    ...
                                    <div class = "row">
                                        <div class="col-lg-14">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="cdpron" name="cdpron" type="text" value="<?php echo $aPron[0]["cdpron"]; ?>" placeholder="" class="form-control" maxlength = "04" autofocus readonly="">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <select name="cdmedi" id="cdmedi" style="width:450px">
                                                        <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                            <?php if ($aUsua[$i]["cdusua"]==$aPron[0]["cdmedi"]){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="cdusua" id="cdusua" style="width:450px">
                                                        <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                            <?php if ($aUsua[$i]["cdusua"]==$aPron[0]["cdusua"]){?>
                                                                <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                            <?php } Else {?>
                                                                <option value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                            <?php }?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="textinput">Descrição Resumida</label>
                                                <div class="col-md-8">
                                                    <input id="deespe" name="deespe" value="<?php echo $aPron[0]["deespe"]; ?>" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="textinput">Descrição Detalhada</label>
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="depron" name="depron" wrap="physical" cols=50 rows=7 placeholder=""><?php echo $aPron[0]["depron"]; ?></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <?php $dtpronD=date("Y-m-d", strtotime($aPron[0]["dtpron"]));?>
                                            ...
                                            <div class="form-group">
                                                <?php $dtpronH=date("H:s", strtotime($aPron[0]["dtpron"]));?>
                                    ...
                                    <div class = "row">
                                        <div class="col-lg-14">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label" for="textinput">Médico</label>
                                                <div class="col-md-4">
                                                    <input type='hidden' id='cdmedi' name='cdmedi' value='<?php echo $aPron[0]["cdmedi"];?>'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label" for="textinput">Paciente</label>
                                                <div class="col-md-4">
                                                    <input type='hidden' id='cdusua' name='cdusua' value='<?php echo $aPron[0]["cdusua"];?>'>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="textinput">Descrição Resumida</label>
                                                <div class="col-md-8">
                                                    <input id="deespe" name="deespe" value="<?php echo $aPron[0]["deespe"]; ?>" type="text" placeholder="" class="form-control" maxlength = "100" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="textinput">Descrição Detalhada</label>
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="depron" name="depron" wrap="physical" cols=50 rows=7 placeholder="" readonly=""><?php echo $aPron[0]["depron"]; ?></textarea>
                                                </div>
                                            </div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Prontuario'},
                    {extend: 'pdf', title: 'Prontuario'},
