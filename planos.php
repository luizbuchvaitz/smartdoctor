<?php
    ...
    if (count($aPara) > 0 ){
        ...
        $detitu = "Smart Doctor | Cadastro de Planos de Saúde";
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-hospital-o"></i> Planos de Saúde
                            </button>
                        </div>

                        <div class="ibox-content">
                        <!--Da permissão para "F" - Funcionário, "A" - Administrador cadastrar planos de saúde-->
                            <?php if ($cdtipo == "F" or $cdtipo == "A"){?>
                            <div class="pull-left">
                                <a onclick="#" href="planosi.php" class="btn btn-info ">Incluir</a>
                            </div>
                            <br>
                            <?php }?>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aPlan)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $coluna1 = $aPlan[$f]["cdplan"]; ?>
                                                <?php $coluna2 = $aPlan[$f]["deplan"]; ?>

                                                <?php $ver = "planosa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "planosa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "planosa.php?acao=apaga&chave=".$coluna1; ?>

                                                <?php $verAgenda = "agenda.php?filtro=plano&chave=".$coluna1; ?>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <p>
                                                        <a onclick="#" href="<?php print $verAgenda; ?>" class="btn btn-info ">Agenda</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        <?php }; ?>    
