                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                    class="fa fa-hospital-o"></i> Cadastro de Planos de Saúde - Inclusão
                        </button>
                    </div>

                    <div class="ibox-content">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="planosg.php">
                            <div>
                                <center>
                            ...
                            <div class = "row">
                                <div class="col-lg-14">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <input id="cdplan" name="cdplan" type="text" value="" placeholder="" class="form-control" maxlength = "02" autofocus required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 ">
                                            <input id="deplan" name="deplan" value="" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                        </div>
                                    </div>
