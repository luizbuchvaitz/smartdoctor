<?php
    ...
    $aAgen = ConsultarDados("agenda", "cdagen", $chave);
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-edit"></i> Agenda / Consultas - <small><?php echo $titulo; ?></small>
                            </button>
                        </div>

                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="agendaaa.php">
                                <div>
                                    <center>
                                        <?php if($acao == "edita") {?>
                                        ...
                                        <?php if($acao == "apaga") {?>
                                            ...
                                            <?php } Else {?>
                                                <button class="btn btn-sm btn-danger" name = "solicCancCons" type="submit"><strong>Solicitar Cancelamento</strong></button>
                                            <?php }?>
                                        <?php }?>
                                        <?php if($acao == "responder") {?>
                                            <button class="btn btn-sm btn-danger" name = "apaga" type="submit"><strong>Aceitar Cancelamento</strong></button>
                                            <button class="btn btn-sm btn-danger" name = "manterCons" type="submit"><strong>Recusar Cancelamento</strong></button>
                                        <?php }?>
                                ...
                                <?php if($acao == "edita") {?>
                                    ...
                                    <div class="col-lg-14">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <input id="cdagen" name="cdagen" type="text" value="<?php echo $aAgen[0]["cdagen"] ;?>" placeholder="" class="form-control" maxlength = "04" autofocus readonly="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <select name="cdmedi" id="cdmedi" style="width:450px">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aAgen[0]["cdmedi"]){?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select name="cdusua" id="cdusua" style="width:450px">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aAgen[0]["cdusua"]){?>
                                                            <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php } Else {?>
                                                            <option value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php }?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input id="vlcons" name="vlcons" value="<?php echo number_format($aAgen[0]["vlcons"],2,",",".") ;?>" type="text" placeholder="" class="form-control" maxlength = "20" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select name="cdform" id="cdform">
                                                    <?php if ($aAgen[0]["cdform"]=='DN'){?>
                                                        <option selected="" value ='DN'>Dinheiro</option>
                                                        <option value ='PS'>Plano de Saúde</option>
                                                        <option value ='CC'>Cartão de Crédito</option>
                                                        <option value ='CD'>Cartão de Débito</option>
                                                        <option value ='CH'>Cheque</option>
                                                    <?php }?>
                                                    <?php if ($aAgen[0]["cdform"]=='PS'){?>
                                                        <option value ='DN'>Dinheiro</option>
                                                        <option selected="" value ='PS'>Plano de Saúde</option>
                                                        <option value ='CC'>Cartão de Crédito</option>
                                                        <option value ='CD'>Cartão de Débito</option>
                                                        <option value ='CH'>Cheque</option>
                                                    <?php }?>
                                                    <?php if ($aAgen[0]["cdform"]=='CC'){?>
                                                        <option value ='DN'>Dinheiro</option>
                                                        <option value ='PS'>Plano de Saúde</option>
                                                        <option selected="" value ='CC'>Cartão de Crédito</option>
                                                        <option value ='CD'>Cartão de Débito</option>
                                                        <option value ='CH'>Cheque</option>
                                                    <?php }?>
                                                    <?php if ($aAgen[0]["cdform"]=='CD'){?>
                                                        <option value ='DN'>Dinheiro</option>
                                                        <option value ='PS'>Plano de Saúde</option>
                                                        <option value ='CC'>Cartão de Crédito</option>
                                                        <option selected="" value ='CD'>Cartão de Débito</option>
                                                        <option value ='CH'>Cheque</option>
                                                    <?php }?>
                                                    <?php if ($aAgen[0]["cdform"]=='CH'){?>
                                                        <option value ='DN'>Dinheiro</option>
                                                        <option value ='PS'>Plano de Saúde</option>
                                                        <option value ='CC'>Cartão de Crédito</option>
                                                        <option value ='CD'>Cartão de Débito</option>
                                                        <option selected="" value ='CH'>Cheque</option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <select name="cdplan" id="cdplan" style="width:450px">
                                                    <?php for ($i=0; $i < count($aPlan); $i++) {?>
                                                        <?php if ($aPlan[$i]["cdplan"]==$aAgen[0]["cdplan"]){?>
                                                            <option selected = "" value = '<?php echo $aPlan[$i]["cdplan"];?>'><?php echo $aPlan[$i]["cdplan"]."-".$aPlan[$i]["deplan"];?></option>
                                                        <?php } Else {?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="deespe" name="deespe" value="<?php echo $aAgen[0]["deespe"] ;?>" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="form-control" id="dedeta" name="dedeta" wrap="physical" cols=50 rows=7 placeholder=""><?php echo $aAgen[0]["dedeta"] ;?></textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <?php $dtpronD=date("Y-m-d", strtotime($aAgen[0]["dtagen"]));?>
                                        ...
                                        <div class="form-group">
                                            <?php $dtpronH=date("H:i", strtotime($aAgen[0]["dtagen"]));?>
                                ...
                                <?php } Else {?>
                                    <div class="col-lg-14">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label" for="textinput">Médico</label>
                                            <div class="col-md-4">
                                                <select name="cdmedi" id="cdmedi" style="width:450px" disabled="">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aAgen[0]["cdmedi"]){?>
                                                            <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php } Else {?>
                                        ...
                                        <div class="form-group">
                                            <?php $aUsua = ConsultarDados("","","","select * from usuarios where cdtipo ='P'");?>
                                            <label class="col-md-3 control-label" for="textinput">Paciente</label>
                                            <div class="col-md-4">
                                                <select name="cdusua" id="cdusua" style="width:450px" disabled="">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aAgen[0]["cdusua"]){?>
                                                            <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php } Else {?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="textinput">Valor a Pagar</label>
                                            <div class="col-md-2">
                                                <input id="vlcons" name="vlcons" value="<?php echo number_format($aAgen[0]["cdagen"],2,",",".") ;?>" type="text" placeholder="" class="form-control" maxlength = "20" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="textinput">Forma de Pagamento</label>
                                            <div class="col-md-4">
                                                <select name="cdform" id="cdform" disabled="">
                                                    <?php if ($aAgen[0]["cdform"]=='DN'){?>
                                                        <option selected="" value ='DN'>Dinheiro</option>
                                                        <option value ='PS'>Plano de Saúde</option>
                                                        <option value ='CC'>Cartão de Crédito</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label" for="textinput">Plano de Saúde</label>
                                            <div class="col-md-4">
                                                <select name="cdplan" id="cdplan" style="width:450px" disabled="">
                                                    <?php for ($i=0; $i < count($aPlan); $i++) {?>
                                                        <?php if ($aPlan[$i]["cdplan"]==$aAgen[0]["cdplan"]){?>
                                                            <option selected = "" value = '<?php echo $aPlan[$i]["cdplan"];?>'><?php echo $aPlan[$i]["cdplan"]."-".$aPlan[$i]["deplan"];?></option>
                                                        <?php } Else {?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="textinput">Especialidade</label>
                                            <div class="col-md-8">
                                                <input id="deespe" name="deespe" value="<?php echo $aAgen[0]["deespe"] ;?>" type="text" placeholder="" class="form-control" maxlength = "100" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="textinput">Detalhes Fornecidos pelo Paciente</label>
                                            <div class="col-md-8">
                                                <textarea class="form-control" id="dedeta" name="dedeta" wrap="physical" cols=50 rows=7 placeholder="" readonly=""><?php echo $aAgen[0]["dedeta"] ;?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label" for="textinput">Data</label>
                                            <div class="col-md-2">
                                                <input id="dtpronD" name="dtpronD" value="<?php echo $dtpronD ;?>" type="date" placeholder="" class="form-control" maxlength = "10" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label" for="textinput">Hora</label>
                                            <div class="col-md-2">
                                                <input id="dtpronH" name="dtpronH" value="<?php echo $dtpronH ;?>" type="time" placeholder="" class="form-control" maxlength = "10" readonly="">
                                            </div>
                                        </div>
        ...
        function pesquisacep(valor) {
            ...
            if (cep != "") {
                ...
                if(validacep.test(cep)) {
                    ...
                    //Exibe um alerta que o cep é inválido.
                    limpa_formulário_cep();
