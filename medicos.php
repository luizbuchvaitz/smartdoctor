<?php
    ...
    if ($cdtipo == 'A' or $cdtipo == 'F'){
        $sql = "select * from usuarios where cdtipo = 'M'";
    } Else {
    ...
    if (count($aPara) > 0 ){
        ...
        $detitu = "Smart Doctor | Cadastro de Médicos";
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-user-md"></i> Médicos
                            </button>
                        </div>

                        <div class="ibox-content">
                            <!-- Da permissão para "F" - Funcionário e "A" - Administrador inserir médicos-->
                            <?php if ($cdtipo == "F" or $cdtipo == "A"){?>
                                <div class="pull-left">
                                    <a onclick="#" href="medicosi.php" class="btn btn-info ">Incluir</a>
                                </div>
                                <br>
                            <?php }?>
                            <br>
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aUsua)-1); $f++) { ?>
                                            <tr class="gradeX">
                                                ...
                                                <?php $coluna7 = $aUsua[$f]["deespe"]; ?>

                                                <?php $ver = "medicosa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "medicosa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "medicosa.php?acao=apaga&chave=".$coluna1; ?>

                                                <?php $verAgenda = "agenda.php?filtro=medico&chave=".$coluna1; ?>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Medicos'},
                    {extend: 'pdf', title: 'Medicos'},
