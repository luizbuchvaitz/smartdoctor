<?php
    ...
    if ($cdtipo == 'A' or $cdtipo == 'F' or $cdtipo == 'M'){
        $sql = "select * from prontuario order by cdusua, dtpron, cdmedi";
    } Else {
        $sql = "select * from prontuario where cdusua = '{$cdusua}' order by cdusua, dtpron, cdmedi";
    }
    $aPron= ConsultarDados("", "", "", $sql);
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <?php if ($cdtipo == "M" or $cdtipo == "A"){?>
                                <div class="pull-left">
                                    <a onclick="#" href="prontuarioi.php" class="btn btn-info ">Incluir</a>
                                </div>
                                <br>
                            <?php }?>
                            <br>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style = "width:10%"><center>Data Atualização</center></th>
                                            <th style = "width:30%"><center>Descrição</center></th>
                                            <th style = "width:10%"class="text-right" data-sort-ignore="true"><center>Ação</center></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aPron)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $coluna0 = $aPron[$f]["cdpron"]; ?>
                                                <?php $coluna1 = $aPron[$f]["cdusua"]; ?>
                                                <?php $coluna2 = $aPron[$f]["cdmedi"]; ?>
                                                <?php $coluna3 = $aPron[$f]["dtpron"]; ?>
                                                <?php $coluna4 = Substr($aPron[$f]["depron"],0,45); ?>
                                                ...
                                                <?php $aUsua= ConsultarDados("usuarios", "cdusua", $coluna1); ?>
                                                <?php if (count($aUsua)>0){?>
                                                    <?php $coluna1 = $aUsua[0]["cdusua"].' - '.$aUsua[0]["deusua"]; ?>
                                                <?php }?>

                                                <?php $ver = "prontuarioa.php?acao=ver&chave=".$coluna0; ?>
                                                <?php $edita = "prontuarioa.php?acao=edita&chave=".$coluna0; ?>
                                                <?php $apaga = "prontuarioa.php?acao=apaga&chave=".$coluna0; ?>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php if ($cdtipo !== 'P'){?>
                                                            ...
                                                            <?php if ($aPron[$f]["cdmedi"] == $cdusua or $cdtipo == 'A'){?>
