                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                    class="fa fa-user-md"></i> Cadastro de Médicos - Inclusão
                        </button>
                    </div>

                    <div class="ibox-content">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="medicosg.php">
                            <div>
                                <center>
                            ...
                            <div class = "row">
                                <div class="col-lg-14">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="deespe" name="deespe" value="" type="text" placeholder="" class="form-control" maxlength = "50">
                                        </div>
                                    </div>
