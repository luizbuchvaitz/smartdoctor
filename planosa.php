<?php
    ...
    $aPlan = ConsultarDados("planos", "cdplan", $chave);
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-hospital-o"></i> Cadastro de Planos de Saúde - <small><?php echo $titulo; ?></small>
                            </button>
                        </div>

                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="planosaa.php">
                                <div>
                                    <center>
                                        <?php if($acao == "edita") {?>
                                        ...
                                        <div class = "row">
                                            <div class="col-lg-14">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input id="cdplan" name="cdplan" type="text" value="<?php echo $aPlan[0]["cdplan"] ;?>" placeholder="" class="form-control" maxlength = "2" autofocus  readonly="">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="textinput">Descrição</label>
                                                    <div class="col-md-8 ">
                                                        <input id="deplan" name="deplan" value="<?php echo $aPlan[0]["deplan"] ;?>" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                                    </div>
                                                </div>
                                        ...
                                        <div class = "row">
                                            <div class="col-lg-14">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="textinput">Descrição</label>
                                                    <div class="col-md-8 ">
                                                        <input id="deplan" name="deplan" value="<?php echo $aPlan[0]["deplan"] ;?>" type="text" placeholder="" class="form-control" maxlength = "100" readonly="">
                                                    </div>
                                                </div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Planos'},
                    {extend: 'pdf', title: 'Planos'},
