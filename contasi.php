<?php
    ...
    $aUsua= ConsultarDados("", "", "","select * from usarios order by cdusua");
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                    class="fa fa-edit"></i> Cadastro de Contas a Receber/Pagar - Inclusão
                        </button>
                    </div>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="contasg.php">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <input id="cdquem" name="cdquem" type ="hidden" value="<?php echo '0,00' ;?>">
                                ...
                                <div class="form-group">
                                    <input id="cdorig" name="cdorig" type ="hidden" value="<?php echo $cdusua ;?>">
                                    <?php $aUsua= ConsultarDados("","","","select * from usuarios");?>
