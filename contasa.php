...
<body>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-calculator"></i> Cadastro de Contas a Receber/Pagar - <small><?php echo $titulo; ?></small>
                            </button>
                        </div>
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="contasaa.php">
                                ...
                                <?php if($acao == "edita") {?>
                                    ...
                                    <div class="row">
                                        <input id="cdcont" name="cdcont" type ="hidden" value="<?php echo $chave ;?>">

                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Descrição Resumida</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input id="vlcont" name="vlcont" value="<?php echo number_format($aCont[0]["vlcont"],2,",",".") ;?>" type="text" placeholder="" class="form-control" maxlength = "15">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input type="hidden" name="cdtipo" id="cdtipo" value="<?php echo $aCont[0]["cdtipo"] ;?>">
                                                <select name="cdtipo" id="cdtipo">
                                                    <?php if ($aCont[0]["cdtipo"]=='R'){?>
                                                        <option value = 'R' selected="">Receber</option>
                                                        <option value = 'P' >Pagar</option>
                                                    <?php }?>
                                                    <?php if ($aCont[0]["cdtipo"]=='P'){?>
                                                        <option value = 'R'>Receber</option>
                                                        <option value = 'P' selected="">Pagar</option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input id="cdquem" name="cdquem" type ="hidden" value="<?php echo $aCont[0]["cdquem"] ;?>">
                                            <?php $aUsua= ConsultarDados("","","","select * from usuarios");?>
                                            <label class="col-md-2 control-label" for="textinput">Favorecido</label>
                                            <div class="col-md-2">
                                                <select name="cdquem" id="cdquem" style="width:450px">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aCont[0]["cdquem"]){?>
                                        ...
                                        <div class="form-group">
                                            <input id="cdorig" name="cdorig" type ="hidden" value="<?php echo $aCont[0]["cdorig"] ;?>">
                                            <?php $aUsua= ConsultarDados("","","","select * from usuarios");?>
                                            <label class="col-md-2 control-label" for="textinput">Cadastrado por</label>
                                            <div class="col-md-2">
                                                <select name="cdorig" id="cdorig" style="width:450px">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aCont[0]["cdorig"]){?>
                                                            <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php } Else {?>
                                                            <option value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php }?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input id="vlpago" name="vlpago" value="<?php echo $aCont[0]["vlpago"] ;?>" type="text" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                ...
                                <?php } Else {?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-2 control-label" for="textinput">Favorecido</label>
                                            <div class="col-md-2">
                                                <select name="cdquem" id="cdquem" style="width:450px" disabled="">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aCont[0]["cdquem"]){?>
                                                            <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php } Else {?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-2 control-label" for="textinput">Cadastrado por</label>
                                            <div class="col-md-2">
                                                <select name="cdorig" id="cdorig" style="width:450px" disabled="">
                                                    <?php for ($i=0; $i < count($aUsua); $i++) {?>
                                                        <?php if ($aUsua[$i]["cdusua"]==$aCont[0]["cdorig"]){?>
                                                            <option selected = "" value = '<?php echo $aUsua[$i]["cdusua"];?>'><?php echo $aUsua[$i]["cdusua"]."-".$aUsua[$i]["deusua"];?></option>
                                                        <?php } Else {?>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            /* Aplica os manipuladores nas tabelas */
