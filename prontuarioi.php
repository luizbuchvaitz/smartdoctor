                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                    class="fa fa-edit"></i> Cadastro de Prontuário - Inclusão
                        </button>
                    </div>

                    <div class="ibox-content">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="prontuariog.php">
                            <div>
                                <center>
                            ...
                            <div class = "row">
                                <div class="col-lg-14">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <input id="cdpron" name="cdpron" type="text" value="" placeholder="" class="form-control" maxlength = "04" autofocus readonly="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" id="depron" name="depron" wrap="physical" cols=50 rows=7 placeholder=""></textarea>
                                        </div>
                                    </div>
