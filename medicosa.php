                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-info btn-lg btn-block"><i
                                                        class="fa fa-user-md"></i> Cadastro de Médicos - <small><?php echo $titulo; ?></small>
                            </button>
                        </div>

                        <div class="ibox-content">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="medicosaa.php">
                                <div>
                                    <center>
                                        <?php if($acao == "edita") {?>
                                        ...
                                        <div class = "row">
                                            <div class="col-lg-14">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="deespe" name="deespe" value="<?php echo $aUsua[0]["deespe"] ;?>" type="text" placeholder="" class="form-control" maxlength = "50">
                                                    </div>
                                                </div>
                                        ...
                                        <div class = "row">
                                            <div class="col-lg-14">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="textinput">Especialidade</label>
                                                    <div class="col-md-8">
                                                        <input id="deespe" name="deespe" value="<?php echo $aUsua[0]["deespe"] ;?>" type="text" placeholder="" class="form-control" maxlength = "50" readonly="">
                                                    </div>
                                                </div>
